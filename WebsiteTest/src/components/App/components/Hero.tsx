...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      >
        <div className="absolute top-20 left-4 sm:left-10 w-48 sm:w-72 h-48 sm:h-72 bg-amber-500/70 rounded-fill blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-4 sm:right-10 w-48 sm:w-72 h-48 sm:h-72 bg-amber-800/70 rounded-fill blur-3xl animate-pulse delay-1000"></div>
      </div>
        ...
        <div className="relative bg-amber-900/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-amber-900/30">
          <div className="bg-gradient-tb from-amber800/20 to amber-500/20 backdrop-blur-sm rounded-lg h[280px] sm:h[350px] lg:[450px] border border-amber-900/15">
            ...
            <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 bg-amber-900/5 backdrop-blur-sm border-b border-amber-900/15">
              ...
              <ChevronDown className="w-3 h-2 sm:w-4 sm:h-4 text-red-700" />
            </div>
          </div>
          <div className="p-3 sm:p-4 relative h-full">
            {/* file tabs */}
            <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-hidden">
              <button
                ...
                } transition-all dureation-200 whitespace-nowrap`}
              >
                App.tsx
              </button>
              <button
